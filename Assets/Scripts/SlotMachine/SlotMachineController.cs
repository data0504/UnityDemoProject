...
public class SlotMachineController : MonoBehaviour
{
    ...
    public GameObject PrefabBingoLine;
    public GameObject AnimaRange;
    public float lastTime = 12f;
    ...
    private void Start()
    {
        ...
        for (int i = 1; i < 10; i+=2)
        {
            ...
            GameObject singleBingoLineObj = Instantiate(PrefabBingoLine, AnimaRange.GetComponent<Transform>());
    ...
    private void SetWidth()
    {
        ...
        for (int i = 0; i < ColumnNumber; i++)
        {
            ...
            GameObject columnObj = Instantiate(PerfabColumn, AnimaRange.GetComponent<Transform>());
        ...
        RectTransform windowSlotRectObj = AnimaRange.GetComponent<RectTransform>();
